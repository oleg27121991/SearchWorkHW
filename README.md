# Проект по автоматизации тестирования для сайта  [Devquality.ru](https://devquality.ru/)
...
Auto:
- ✓ Отправка пустой формы 'Оставьте заявку'
- ✓ Отправка формы 'Оставьте заявку' с некорректным email
- ✓ Отправка формы с незаполненным полем 'Ваш телефон или e-mail'
- ✓ Отправка формы с незаполненным полем 'Текст обращения'
- ✓ Появление pop-up окна с формой 'Оставьте заявку' после клика на кнопку в баннерной секции сайта
- ✓ Проверка локализации заголовка h1 на главной странице
...
gradle clean positive_test  запуск позитивных кейсов
gradle clean negative_test запуск негативных кейсов
```
____
<a id="jenkins"></a>
